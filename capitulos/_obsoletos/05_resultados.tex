...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Referencias de ensemble learning en literatura:} La literatura científica reporta diversos enfoques de ensemble learning aplicados a detección de fraude. Por ejemplo, \textcite{Feng2024} documentan el uso de gradient boosting (XGBoost) en contextos de fraude en e-commerce, alcanzando F1-Scores de 90-94\% sobre un dataset de 150K transacciones.
...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Competitividad frente a literatura científica:} El modelo desarrollado se posiciona en el rango superior de benchmarks reportados en literatura científica para detección de fraude, superando a enfoques de Deep Learning y análisis de grafos documentados en estudios recientes.
