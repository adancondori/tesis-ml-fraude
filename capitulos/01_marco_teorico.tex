...
SVM busca el hiperplano óptimo que maximiza el margen entre clases en un espacio de mayor dimensión mediante kernel tricks \parencite{James2021}. La función de decisión es:
...
Se realizó una revisión sistemática de literatura científica siguiendo las directrices de \textcite{Hernandez2018}, con los siguientes criterios:
