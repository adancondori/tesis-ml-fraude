...
% Times New Roman (recomendado por Sampieri y APA 7)
...
% Interlineado según normas UAGRM
\usepackage{setspace}
...
% Sangría francesa en referencias (APA 7: 1.27cm = 0.5 pulgadas)
...
% Colores para tablas y diagramas
\definecolor{headerblue}{RGB}{41,128,185}  % Azul para encabezados de tablas
\definecolor{lightblue}{RGB}{174,214,241}  % Azul claro para diagramas
\definecolor{lightgreen}{RGB}{200,230,201} % Verde claro para resaltar resultados positivos
